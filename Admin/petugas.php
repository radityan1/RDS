                                ...
                                <?php 
				                    ...
				                    ?>
                                        <tr>
                                            ...
                                            <td><a href="" bhr class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#inlineForm1<?php echo $d['id_petugas'];?>">Ubah</a>
                                            <div class="modal fade text-left" id="inlineForm1<?php echo $d['id_petugas'];?>" tabindex="-1"
                                                    ...
                                                    <input type="hidden" name="id_petugas" value= "<?=$d['id_petugas']?>">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                class="form-control" value="<?=$d['username']?>">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <input  value="<?=$d['nama_petugas']?>" type="text" name="nama_petugas" placeholder="angkatan"
                                                                class="form-control">
                                                            </div>
                                                        </div>
                                            ...
                                            <td><a href="hapus_petugas.php?id_petugas=<?=$d['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                        <?php
			                            }
